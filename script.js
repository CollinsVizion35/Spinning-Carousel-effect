...
$("#section").mouseup(function() {
    ...
    if (timesClicked === 1 ||  ((timesClicked - 1) % 4 === 0)) {
    ...
    } else if (timesClicked === 2 ||  ((timesClicked - 2) % 4 === 0)) {
        main.classList.add('main_animate');
    } else if (timesClicked === 3 ||  timesClicked % 4 === 3) {
        article.classList.add('article_animate');
        setTimeout (() => {
            mainDiv.style.display = 'flex';
            main.style.display = 'none';
           }, 1000);
    } else if (timesClicked === 4 ||  timesClicked % 4 === 4) {
